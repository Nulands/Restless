 ...
 static class SimpleJson
    {
        ...
        public static string SerializeObject(object json, bool clrPropertyNameToLower = false)
        {
            PocoJsonSerializerStrategy.ClrPropertyNameToLower = clrPropertyNameToLower;
 ...
 class PocoJsonSerializerStrategy : IJsonSerializerStrategy
    {
        ...
        internal bool ClrPropertyNameToLower { get; set; }
        ...
        protected virtual string MapClrMemberNameToJsonFieldName(string clrPropertyName)
        {
            if (ClrPropertyNameToLower)
                clrPropertyName = clrPropertyName.ToLower();
